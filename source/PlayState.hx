...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("DK Inky Fingers.otf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		timeBar.createGradientBar([0xFF000000], [FlxColor.fromRGB(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]), FlxColor.fromRGB(dad.healthColorArray[0], dad.healthColorArray[1], dad.healthColorArray[2])]);
		...
		healthBar = new FlxBar(healthBarBG.x + 39, healthBarBG.y + 46, RIGHT_TO_LEFT, Std.int(healthBarBG.width - 79), Std.int(healthBarBG.height - 100), this,
			'health', 0, 2);
		...
		scoreTxt = new FlxText(0, healthBarBG.y + 86, FlxG.width, "", 20);
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
			{
				...
				switch (swagCounter)
				{
					case 0:
						...
						FlxTween.tween(countdownThree, {/*y: countdownThree.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
					...
					case 2:
						...
						countdownOne.updateHitbox();

						countdownOne.screenCenter();
						countdownOne.antialiasing = antialias;
						insert(members.indexOf(notes), countdownOne);
						FlxTween.tween(countdownOne, {/*y: countdownOne.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
							ease: FlxEase.cubeInOut,
							onComplete: function(twn:FlxTween)
							{
								remove(countdownOne);
